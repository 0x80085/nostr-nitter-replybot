...
import { NostrInteractorService } from './nostr-interactor.service';

describe('NostrService', () => {
  let service: NostrInteractorService;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        NostrInteractorService,
        {
          provide: ReplyCacheService,
          useValue: {
            cacheRepliedToEvent: jest.fn(),
    ...
    service = module.get<NostrInteractorService>(NostrInteractorService);
